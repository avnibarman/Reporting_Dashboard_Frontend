...
//fourth tile in the page with twp dropdowns that powers the pie chart with 
//the number of times remote operations were above average/expected response times
var _this;
class Dropdown3 extends React.Component {
  ...
  //handles changes on the first dropdown
  handleChange1(event) {
  ...
  //handles changes on the second dropdown
  handleChange2(event){
